...
function createCoins() {
    ...
    coinCreate(50, 550, 'coin');
    coinCreate(150, 300, 'coin');
    coinCreate(600, 50, 'coin');
    coinCreate(200, 200, 'coin');
    coinCreate(600, 400, 'coin');
    coinCreate(400, 100, 'coin');
...
function createStars() {
    ...
    starCreate(500, 200, 'star');
    starCreate(275, 200, 'star');
